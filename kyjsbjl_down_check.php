...
$stmt = $dbh->prepare("SELECT id,machine_id,register_time from kyjrecords where id=:id");
...
<main class="flex-shrink-0">
  <div class="container mt-lg-4">
    ...
    <form class="row g-3 needs-validation" novalidate="" action="kyjsbjl_down_save.php" method="post">
      ...
      <div class="col-12">
        <button class="btn btn- btn-sm" type="submit">关&nbsp;机</button>
      </div>
      <script>
        (() => {
          'use strict'
