...
$stmt = $dbh->prepare("select machine_id,machine_name from bsjsb where machine_status = 'T' order by id");
$stmt->execute();
$rows = $stmt->fetchAll();
?>
  <main class="flex-shrink-0">
    <div class="container mt-lg-4">
      ...
      <form class="row g-3 needs-validation" novalidate="" action="bsjsbjl_save.php" method="post">
        <div class="col-sm-2">
