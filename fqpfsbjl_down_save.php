...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($id)) {
        ...
        $stmt = $dbh->prepare("SELECT id,machine_status from fqssrecords where id=:id and machine_status='关机'");
        ...
        $sql = "update fqssrecords set shutdown_time=:shutdown_time,total_duration=:total_duration,machine_status=:machine_status where id=:id";
