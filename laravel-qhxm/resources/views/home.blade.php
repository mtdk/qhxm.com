                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-hdd-stack"></i> 设备监控</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-tools"></i> 设备维修</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-plus-circle"></i> 工单登记</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-list-check"></i> 工单查询</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-person"></i> 用户信息</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-key"></i> 密码修改</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="d-flex">
                    <span class="navbar-text me-3">
                        <i class="bi bi-person"></i> 欢迎您，用户
                    </span>
