...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($machine_id)) {
        ...
        $sql = "SELECT machine_id FROM bsjrecords WHERE machine_id=:machine_id and machine_status=:machine_status";
        ...
        $sql = "INSERT INTO bsjrecords (machine_id,register_date,register_time,machine_status,uid) VALUES (?,?,?,?,?)";
        $stmt = $dbh->prepare($sql);
