...
$stmt = $dbh->prepare("SELECT id,machine_id,register_date,register_time,pro_id,bath_number,work_id from ymsbrecords where id=:id");
...
<main class="flex-shrink-0">
    <div class="container mt-lg-4">
        ...
        <form class="row g-3 needs-validation" novalidate="" action="ymsbjl_down_save.php" method="post">
