...
$stmt = $dbh->prepare("select machine_id,machine_name from ymsb where machine_status = 'T' order by id");
$stmt->execute();
$rows = $stmt->fetchAll();
?>
    <main class="flex-shrink-0">
        <div class="container mt-lg-4">
            ...
            <form class="row g-3 needs-validation" novalidate="" action="ymsbjl_save.php" method="post">
                <div class="col-sm-2">
                    <label for="validationmachine" class="form-label">研磨设备选择</label>
