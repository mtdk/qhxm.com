            ...
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <?php elseif ($department_id == 2 && $role_id == 2): ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" href="/fssb_rds_up.php">分散记录修改</a></li>
                            <li><a class="dropdown-item" href="/ymsb_rds_up.php">研磨记录修改</a></li>
                            <li><a class="dropdown-item" href="/fqpfsb_rds_up.php">废气设备记录修改</a></li>
                            <li><a class="dropdown-item" href="/bsj_rds_up.php">冰水机记录修改</a></li>
                            <li><a class="dropdown-item" href="/kyj_rds_up.php">空压机记录修改</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <button class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
