...
$stmt = $dbh->prepare("SELECT id,machine_id,register_time from bsjrecords where id=:id");
...
<main class="flex-shrink-0">
  <div class="container mt-lg-4">
    ...
    <form class="row g-3 needs-validation" novalidate="" action="bsjsbjl_down_save.php" method="post">
