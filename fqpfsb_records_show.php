...
$sql = "SELECT machine_id,register_date,register_time,shutdown_time,total_duration,machine_status,uname FROM fqpfsbjl_show where register_date=? order by register_date desc LIMIT ?,?";
$stmt = $dbh->prepare($sql);
$stmt->bindValue(1, $rd);
                ...
                <nav aria-label="Page navigation example">
                    <?php if (ceil($total / $pageNum) > 0): ?>
                        <ul class="pagination justify-content-center">
                            <?php if ($page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="fqpfsb_records_show.php?page=<?php echo $page - 1 ?>"><span
                                                aria-hidden="true">&laquo;</span></a>
                                </li>
                            <?php endif; ?>

                            <?php if ($page > 3): ?>
                                <li class="page-item"><a class="page-link" href="fqpfsb_records_show.php?page=1">1</a>
                                </li>
                            ...
                            <?php if ($page - 2 > 0): ?>
                                <li class="page-item">
                                <a class="page-link"
                                   href="fqpfsb_records_show.php?page=<?php echo $page - 2 ?>"><?php echo $page - 2 ?></a>
                                </li><?php endif; ?>
                            <?php if ($page - 1 > 0): ?>
                                <li class="page-item">
                                <a class="page-link"
                                   href="fqpfsb_records_show.php?page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a>
                                </li><?php endif; ?>

                            <li class="page-item">
                                <a class="page-link"
                                   href="fqpfsb_records_show.php?page=<?php echo $page ?>"><?php echo $page ?></a>
                            </li>
                            ...
                            <?php if ($page < ceil($total / $pageNum) - 2): ?>
                                ...
                                <li class="page-item">
                                    <a class="page-link"
                                       href="fqpfsb_records_show.php?page=<?php echo ceil($total / $pageNum) ?>"><?php echo ceil($total / $pageNum) ?></a>
                                </li>
                            <?php endif; ?>
